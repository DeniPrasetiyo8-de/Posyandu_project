...
<!-- Stats Cards -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        <div class="bg-blue-500 p-8 rounded-3xl border border-gray-700 hover:border-gray-600 transition-all">
            <div class="flex items-center justify-between mb-4">
                <div class="p-4 bg-pink-500 rounded-2xl">
...
<!-- Recent Activities -->
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <!-- Recent Jadwal -->
        <div class="bg-blue-500 rounded-3xl p-8 border border-gray-700">
            <h3 class="text-2xl font-bold text-white mb-6 flex items-center">
                <i class="fas fa-calendar mr-3 text-pink-400"></i>Jadwal Terbaru
            </h3>
            <div class="space-y-4">
                @forelse($recentJadwals as $jadwal)
                    <div class="flex items-center p-4 bg-gray-500 rounded-2xl hover:bg-gray-700 transition-all">
                        <div class="w-12 h-12 bg-pink-700 rounded-xl flex items-center justify-center mr-4">
                            <i class="fas fa-calendar-day text-white font-bold"></i>
                        </div>
                        <div class="flex-1">
                            <h4 class="font-bold text-white text-lg">{{ $jadwal->kegiatan }}</h4>
                            <p class="text-white-300">{{ $jadwal->tanggal }}</p>
                            <p class="text-sm text-white-400">{{ $jadwal->posyandu->nama_posyandu ?? 'Semua RW' }}</p>
                        </div>
        ...
        <div class="bg-blue-500 rounded-3xl p-8 border border-gray-700">
            ...
            <div class="space-y-4">
                @forelse($recentChildren as $child)
                    <div class="flex items-center p-4 bg-gray-500 rounded-2xl hover:bg-gray-700 transition-all">
                        <div class="w-12 h-12 bg-pink-700 rounded-full flex items-center justify-center mr-4 text-white font-bold">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-white-400">{{ $child->posyandu->nama_posyandu ?? 'N/A' }}</p>
                        </div>
...
<!-- Quick Actions -->
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mt-12">
        <a href="/admin/artikel" class="group bg-blue-500 p-8 rounded-3xl border border-gray-700 hover:border-gray-600 transition-all transform hover:-translate-y-2 block text-center">
        ...
        <a href="/admin/jadwal" class="group bg-blue-500 p-8 rounded-3xl border border-gray-700 hover:border-gray-600 transition-all transform hover:-translate-y-2 block text-center">
        ...
        <a href="/admin/kader" class="group bg-blue-500 p-8 rounded-3xl border border-gray-700 hover:border-gray-600 transition-all transform hover:-translate-y-2 block text-center">
...
<a href="/admin/laporan" class="group bg-blue-500 p-8 rounded-3xl border border-gray-700 hover:border-gray-600 transition-all transform hover:-translate-y-2 block text-center">
            <i class="fas fa-file-alt text-4xl mb-4 block mx-auto group-hover:rotate-12 transition-transform text-purple-400"></i>
            <h3 class="text-2xl font-bold mb-2 text-white">Laporan Posyandu</h3>
            <p class="opacity-90 text-gray-300">Laporan & export data</p>
        </a>
        <a href="/admin/informasi" class="group bg-blue-500 p-8 rounded-3xl border border-gray-700 hover:border-gray-600 transition-all transform hover:-translate-y-2 block text-center">
