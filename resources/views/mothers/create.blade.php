...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-pink-900 to-slate-900 py-12">
    <div class="max-w-2xl mx-auto p-8">
        <div class="text-center mb-12">
            ...
            <h1 class="text-4xl font-bold text-white mb-4">Tambah Data Ibu</h1>
            <p class="text-xl text-slate-300">Isi data lengkap ibu untuk pemantauan KMS</p>
        </div>

        <form action="{{ route('mothers.store') }}" method="POST" enctype="multipart/form-data" class="bg-slate-800/50 backdrop-blur-xl rounded-3xl p-10 border border-slate-700 shadow-2xl">
            @csrf
...
<!-- Nama Lengkap -->
            ...
            <div class="mb-8">
                ...
                <input type="date" name="tanggal_kehamilan" value="{{ old('tanggal_kehamilan') }}" max="{{ date('Y-m-d') }}"
            ...
            <!-- Foto Profil -->
            <div class="mb-12">
                <label class="block text-white font-bold mb-4 text-xl">Foto Profil Ibu</label>
                <div class="relative">
