...
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-2xl mx-auto p-8">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Tambah Data Ibu</h1>
            <p class="text-gray-500">Isi data lengkap ibu untuk pemantauan KMS</p>
        </div>

        <form action="{{ route('mothers.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl p-8 border border-gray-200 shadow-lg">
            @csrf
            ...
            <!-- Foto Profil -->
            <div class="mb-6">
                <label class="block text-gray-700 font-bold mb-2">Foto Profil Ibu</label>
